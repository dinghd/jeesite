...
<body>
	...
	<form:form id="inputForm" modelAttribute="score" action="${ctx}/sms/score/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="student.name" htmlEscape="false" maxlength="200" class="input-xlarge required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">课程:</label>
			<div class="controls">
				<form:input path="course.name" htmlEscape="false" maxlength="200" class="input-xlarge required"/>
			</div>
		</div>
		<div class="control-group">
